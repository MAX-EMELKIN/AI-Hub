// =============================================================================
// Сервис: OpenAI GPT-OSS 120B (Автономный мост к AI Hub)
// ID: 685
// =============================================================================

var LOCAL_URL    = "http://127.0.0.1:8080";
var SERVICE_ID   = 685;
var SERVICE_NAME = "OpenAI 120B";
var _IS_ALIVE    = false;
...
function serviceHeader() {
    return new ServiceHeader(
        SERVICE_ID,
        SERVICE_NAME,
        "OpenAI GPT-OSS 120B via QTranslate AI Hub" + Const.NL2 + LOCAL_URL,
...
function serviceLink(text, from, to) {
    return "https://developers.cloudflare.com/workers-ai/";
}
...
function serviceTranslateRequest(text, from, to) {
    try {
        ...
        return new RequestData(HttpMethod.POST, "/openai_120b", stringifyJSON(payload), headers, CodePage.UTF8);
    } catch (e) {
