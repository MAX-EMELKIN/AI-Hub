// =============================================================================
// Сервис: Qwen Turbo (Alibaba DashScope)
// ID: 705
// =============================================================================

var LOCAL_URL    = "http://127.0.0.1:8080";
var SERVICE_ID   = 705;
var SERVICE_NAME = "Qwen Turbo";
var _IS_ALIVE    = false;
...
function serviceHeader() {
    return new ServiceHeader(
        SERVICE_ID,
        SERVICE_NAME,
        "Qwen Turbo (Alibaba DashScope) via QTranslate AI Hub" + Const.NL2 + LOCAL_URL,
...
function serviceTranslateRequest(text, from, to) {
    try {
        ...
        return new RequestData(HttpMethod.POST, "/qwen_turbo", stringifyJSON(payload), headers, CodePage.UTF8);
    } catch (e) {
