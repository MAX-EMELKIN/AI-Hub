// =============================================================================
// Сервис: nemotron-3-super-120b (Автономный мост к AI Hub)
// ID: 715
// =============================================================================

var LOCAL_URL    = "http://127.0.0.1:8080";
var SERVICE_ID   = 715;
var SERVICE_NAME = "nemotron-3-super-120b";
var _IS_ALIVE    = false;
...
function serviceHeader() {
    return new ServiceHeader(
        SERVICE_ID,
        SERVICE_NAME,
        "nemotron-3-super-120b via QTranslate AI Hub" + Const.NL2 + LOCAL_URL,
...
function serviceTranslateRequest(text, from, to) {
    try {
        ...
        return new RequestData(HttpMethod.POST, "/nemotron_3_super_120b", stringifyJSON(payload), headers, CodePage.UTF8);
    } catch (e) {
