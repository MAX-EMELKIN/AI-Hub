// =============================================================================
// Сервис: z-ai/glm-5.3 (Автономный мост к AI Hub)
// ID: 701
// =============================================================================

var LOCAL_URL    = "http://127.0.0.1:8080";
var SERVICE_ID   = 701;
var SERVICE_NAME = "z-ai/glm-5.3";
var _IS_ALIVE    = false;
...
function serviceHeader() {
    return new ServiceHeader(
        SERVICE_ID,
        SERVICE_NAME,
        "z-ai/glm-5.3 via QTranslate AI Hub" + Const.NL2 + LOCAL_URL,
...
function serviceTranslateRequest(text, from, to) {
    try {
        ...
        return new RequestData(HttpMethod.POST, "/z_ai_glm_5_3", stringifyJSON(payload), headers, CodePage.UTF8);
    } catch (e) {
