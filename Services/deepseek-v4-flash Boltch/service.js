// =============================================================================
// Сервис: deepseek-v4-flash Boltch (Автономный мост к AI Hub)
// ID: 712
// =============================================================================

var LOCAL_URL    = "http://127.0.0.1:8080";
var SERVICE_ID   = 712;
var SERVICE_NAME = "deepseek-v4-flash Boltch";
var _IS_ALIVE    = false;
...
function serviceHeader() {
    return new ServiceHeader(
        SERVICE_ID,
        SERVICE_NAME,
        "deepseek-v4-flash Boltch via QTranslate AI Hub" + Const.NL2 + LOCAL_URL,
...
function serviceLink(text, from, to) {
    return "http://127.0.0.1:8080/status";
}
...
function serviceTranslateRequest(text, from, to) {
    try {
        ...
        return new RequestData(HttpMethod.POST, "/deepseek_v4_flash_boltch", stringifyJSON(payload), headers, CodePage.UTF8);
    } catch (e) {
