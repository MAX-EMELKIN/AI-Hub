// =============================================================================
// Сервис: NVIDIA Nemotron 3.5 (OpenRouter Free)
// ID: 708
// =============================================================================

var LOCAL_URL    = "http://127.0.0.1:8080";
var SERVICE_ID   = 708;
var SERVICE_NAME = "NVIDIA Nemotron 3.5";
var _IS_ALIVE    = false;
...
function serviceHeader() {
    return new ServiceHeader(
        SERVICE_ID,
        SERVICE_NAME,
        "NVIDIA Nemotron 3.5 (OpenRouter Free) via QTranslate AI Hub" + Const.NL2 + LOCAL_URL,
...
function serviceLink(text, from, to) {
    return "https://openrouter.ai/nvidia/nemotron-3.5-lightning:free";
}
...
function serviceTranslateRequest(text, from, to) {
    try {
        ...
        return new RequestData(HttpMethod.POST, "/openrouter_nemotron_3_5", stringifyJSON(payload), headers, CodePage.UTF8);
    } catch (e) {
