// =============================================================================
// Сервис: llama-3.3-70b OpenRouter (Автономный мост к AI Hub)
// ID: 714
// =============================================================================

var LOCAL_URL    = "http://127.0.0.1:8080";
var SERVICE_ID   = 714;
var SERVICE_NAME = "llama-3.3-70b OpenRouter";
var _IS_ALIVE    = false;
...
function serviceHeader() {
    return new ServiceHeader(
        SERVICE_ID,
        SERVICE_NAME,
        "llama-3.3-70b OpenRouter via QTranslate AI Hub" + Const.NL2 + LOCAL_URL,
...
function serviceTranslateRequest(text, from, to) {
    try {
        ...
        return new RequestData(HttpMethod.POST, "/llama_3_3_70b_openrouter", stringifyJSON(payload), headers, CodePage.UTF8);
    } catch (e) {
