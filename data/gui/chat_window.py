# -*- coding: utf-8 -*-
"""
Модуль: data/gui/chat_window.py
Назначение: Автономное окно чата с ИИ-моделями с выбором модели на лету,
            агентным веб-поиском, адаптивной версткой панели ввода,
            увеличенными таймаутами (до 70с), защитой от превышения шагов поиска
...
class UniversalChatClient:
    """Универсальный клиент для отправки сообщений с поддержкой истории, поиска, таймаутов и логирования."""
...
class ChatWindow(tk.Toplevel):
    """Окно общения с ИИ (Chat) с сохранением геометрии и адаптированной панелью ввода."""
