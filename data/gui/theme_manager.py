# -*- coding: utf-8 -*-
"""
Модуль: data/gui/theme_manager.py
Назначение: Менеджер тем оформления (Light, Dark, Gray, Nord, Ochre), локализованных названий и Unicode-шрифтов.
...
class ThemeManager:
    def __init__(self):
        ...
        # Мультиязычный стек шрифтов Windows с гарантией отображения CJK и диакритики
    ...
    def get_theme_display_options(self):
        """Возвращает локализованные имена тем для меню: [(key, localized_name), ...]."""
        result = []
    ...
    def get_font_display_options(self):
        """Возвращает локализованные размеры шрифта: [(scale_key, localized_name), ...]."""
        result = []
    ...
    def apply_ttk_theme(self, root=None):
        """Принудительная настройка TTK стилей с правильным маппингом комбобоксов и скроллбара."""
        style = ttk.Style()
        try:
