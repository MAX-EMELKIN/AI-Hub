...
DEFAULT_PRESETS_DATA = {
    "default": (
        ...
        "2. Терминология: устоявшиеся официальные термины пиши на целевом языке, "
        "уникальные бренды без перевода — в оригинале (без скобок с дублированием)."
    ),
    "games": (
        "Ты — профессиональный локализатор видеоигр. Сделай живой и атмосферный перевод на {TARGET_LANG}.\n"
        "ПРАВИЛА:\n"
        "1. Живая речь: переводи диалоги персонажей естественно. Если в оригинале есть игровой сленг, "
        "грубость, ругань или юмор — смело и сочно адаптируй их под колорит целевого языка.\n"
...
class PresetManager:
    ...
    def save_preset(self, service_id, preset_name, content):
        ...
        try:
            ...
            print(f"[PresetManager Ошибка]: Не удалось сохранить пресет '{preset_name}' для '{service_id}': {e}")
            return False
