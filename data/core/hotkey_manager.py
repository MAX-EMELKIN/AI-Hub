# -*- coding: utf-8 -*-
"""
Модуль: data/core/hotkey_manager.py
Назначение: Глобальные хоткеи и фоновый трекер активного окна (ActiveWindowTracker) для безошибочного захвата.
Совместимость: Python 3.8+ / Windows 7, 8, 10, 11 (x64 / x86)
"""
...
# Системные окна, которые трекер игнорирует (панель задач, трей, рабочий стол)
...
class ActiveWindowTracker:
    """Постоянно помнит настоящее окно пользователя (браузер, читалку, PDF, игру)."""
    def __init__(self):
