# -*- coding: utf-8 -*-
"""
Модуль: data/core/config_manager.py
Назначение: Управление config.ini, расположенным внутри папки data/.
            Включает параметры окна, тем, сервисов, OCR, горячих клавиш и секцию [LOGGING].
