...
def run():
    ...
    print("=================================================================")
    print("  QTranslate AI Hub — Универсальный шлюз нейросетей")
    print("  Порт сервера: 8080 | Режим работы: WinAPI / Tkinter")
    print("=================================================================")
    logger.system("Инициализация ядра QTranslate AI Hub")
    ...
    def _on_app_exit():
        ...
        logger.system("Остановка всех служб и выход")
        stop_server()
        try:
    ...
    if start_minimized:
        app.withdraw()
        print("Приложение запущено и свернуто в системный трей.")
        logger.system("Окно свернуто в трей при запуске")
    else:
        app.deiconify()
