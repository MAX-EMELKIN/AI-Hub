# -*- coding: utf-8 -*-
"""
Модуль: data/services/gemini_family/service.py
Назначение: Универсальный сервис семейства моделей Google Gemini с агентным Function Calling
            (поиск через DuckDuckGo и чтение веб-страниц по инициативе модели),
            настраиваемым промптом поиска, авторизацией x-goog-api-key,
            встроенным DoH SmartDNS для РФ, поддержкой прокси и полной интеграцией с logger.
